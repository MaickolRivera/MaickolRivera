...
### Software Developer — building full-stack web apps, from interactive UIs to APIs

I like building things end to end: clean interfaces in React and TypeScript, backends in FastAPI, and everything deployed and usable. I also have hands-on experience with data pipelines and AI tools (RAG, LLM integration), which I bring into the way I build software.
...
- 🎓 Studying Software Engineering @ UCompensar
- 🌍 English B2
- 📊 Currently into: ETL pipelines, Looker Studio dashboards, RAG / LLM apps
<br>
